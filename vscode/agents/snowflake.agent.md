...
handoffs:
  - label: "Documentation"
    agent: "🐋 Wally"
    prompt: "Document the C#/.NET app I just implemented following the project rules."
  - label: "Back to Lobby"
    agent: "👩🏽‍🎤 Lobby"
    prompt: "C#/.NET implementation is done. Here is a summary of what was implemented; consolidate and continue."
---
